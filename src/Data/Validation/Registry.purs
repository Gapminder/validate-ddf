...
errorMessageTemplate = case _ of
  ...
  E_CONCEPT_DRILLUP_FORMAT -> "drill_up must be space-separated values, not JSON array"
  E_CONCEPT_SCALES_FORMAT -> "scales must be space-separated values, not JSON array"
  E_CONCEPT_TAGS_FORMAT -> "tags must be space-separated values, not JSON array"
...
errorSuggestion = case _ of
  ...
  E_CONCEPT_FIELD_EMPTY -> ""
  E_CONCEPT_FIELD_MISSING -> ""
  E_CONCEPT_DRILLUP_FORMAT -> "e.g. \"foo bar\" (space-separated)"
  E_CONCEPT_SCALES_FORMAT -> "e.g. \"linear log\" (space-separated)"
  E_CONCEPT_TAGS_FORMAT -> "e.g. \"foo bar\" (space-separated)"
